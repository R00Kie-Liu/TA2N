...
sys.path.append('/home/hbliu/InfoMax-action-FSL/')
from utils_info import split_first_dim_linear
import math
...
class TemporalCrossTransformer(nn.Module):
    ...
    def forward(self, support_set, support_labels, queries):
        #print('support shape', support_set.shape)  [way, frame_num, feature_dim]
        #print('support labels', support_labels.shape) [way]
        #print('queries', queries.shape) [way * query_per_class, frame_num, feature_dim]
        ...
        unique_labels = torch.unique(support_labels) # unique能挑出集合中的独立不重复元素
        ...
        #print('distance', all_distances_tensor)
